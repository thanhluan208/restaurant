...
class Vision:
    ...
    def draw_rectangles(self, haystack_img, rectangles):
        ...
        for (x, y, w, h) in rectangles:
            ...
            # draw the box
            w_array = [29,47,51,52]
            if w in w_array or w == 51 :
                cv.rectangle(haystack_img, top_left, bottom_right, (0, 255, 0), lineType=line_type)
            elif w > 50 :
                cv.rectangle(haystack_img, top_left, bottom_right, (0, 0, 255), lineType=line_type)
            else:
                cv.rectangle(haystack_img, top_left, bottom_right, (255, 0, 0), lineType=line_type)
